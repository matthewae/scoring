...
<head>
    ...
    <title>Login - PT. Mandajaya Rekayasa Konstruksi</title>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7 offset-md-5">
                <div class="login-right">
                    <h4 class="mb-4 fw-bold">Masuk ke Akun Anda</h4>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn-toggle-password btn" tabindex="-1">👁️</button>
                            </div>
                            @error('password')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a class="btn btn-register" href="{{ route('register') }}">Daftar Sekarang</a>
                        </div>
                    </form>
                </div>
            </div>
